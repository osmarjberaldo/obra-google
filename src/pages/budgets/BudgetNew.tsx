...
// Marcador para campos obrigatórios
const RequiredMark = () => (
...
const formatPhoneBR = (input: string) => {
  ...
  return `(${d.slice(0, 2)}) ${d.slice(2, 7)}-${d.slice(7)}`; // 11 dígitos (celular)
};
...
const BudgetNew = () => {
  ...
  // Manter o campo de valor sincronizado com o total calculado, quando vazio
  useEffect(() => {
  ...
  // Carregar obras do usuário para seleção
  useEffect(() => {
