<?php
// Script de diagnóstico para entender o fluxo de autenticação do cliente
...
// Log de diagnóstico
error_log("=== Diagnóstico de Autenticação de Cliente ===");
...
if ($cliente && password_verify($password, $cliente['senha'])) {
    ...
    error_log("Dados retornados: " . print_r($data, true));
